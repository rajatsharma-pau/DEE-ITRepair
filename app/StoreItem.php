...
{
    protected $fillable = ['college_id','department_id','item_code','name','category','brand','unit','opening_stock','current_stock','reorder_level','location','description','is_active'];
